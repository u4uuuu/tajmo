...
try:
    ...
    api_id = int('25711601')
    api_hash = '39f9968b282050cf16890e129b99faca'
    bot_token = '6592308802:AAHAn1rhFSGozovWbIZ-N-tXTqnDd6fq_Y0'
    DEVLOO = '6361546144'
    MAX_ACCOUNTS = int('3')
    user_bot = 'insteagiftbot'
    id_bot = int('6592308802')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6361546144))
...
async def mainlogin(event):
    async with bot.conversation(event.sender_id) as conv:
        api_id = 25711601 # Your Api ID
        api_hash = '39f9968b282050cf16890e129b99faca' # Your Api Hash
        try: 
